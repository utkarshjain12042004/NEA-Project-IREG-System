...
class View_Attendance:
    ...
    def __init__(self, root):
        ...
        # Label Frame
        View_Attendance_lbl= Label(mainFrame, text="View Attendance", font=("Segoe UI Variable", 45, "bold"), bg="White", fg="Black")
        View_Attendance_lbl.place(x=1, y=5, width=1270, height=75) # Specifying the coordinates along with the dimensions of the frame
